...
1. Deploying Nginx Container
    ...
    # kubectl run sample-devops-project --image=yankils/sample-devops-image --replicas=2 --port=8080
    kubectl get pods
...
1. Expose the deployment as service. This will create an ELB in front of those 2 containers and allow us to publicly access them.
   ...
   # kubectl expose deployment sample-devops-project --port=8080 --type=LoadBalancer
